...
use amethyst::renderer::{
    ...
    SpriteSheetHandle, Texture, TextureHandle, TextureMetadata,
};
...
fn load_sprite_sheet(world: &mut World) -> SpriteSheetHandle {
    ...
    let texture_handle = {
        ...
        loader.load(
            format!("{}/textures/pong_spritesheet.png", application_root_dir()),
            PngFormat,
    ...
    loader.load(
        format!("{}/textures/pong_spritesheet.ron", application_root_dir()),
        SpriteSheetFormat,
